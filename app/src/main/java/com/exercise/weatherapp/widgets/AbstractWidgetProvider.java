package com.exercise.weatherapp.widgets;
...
import com.exercise.weatherapp.BuildConfig;
...
public abstract class AbstractWidgetProvider extends AppWidgetProvider {
    ...
    protected Weather parseWidgetJson(String result, Context context) {
        try {
            ...
            widgetWeather.setIcon(setWeatherIcon(Integer.parseInt(reader.optJSONArray("weather").getJSONObject(0).getString("id")), TimeUtils.isDayTime(widgetWeather, Calendar.getInstance()), context));
