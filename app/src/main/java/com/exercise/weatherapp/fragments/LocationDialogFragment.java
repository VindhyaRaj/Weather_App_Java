package com.exercise.weatherapp.fragments;
...
import com.exercise.weatherapp.activities.MainActivity;
...
import com.exercise.weatherapp.adapters.LocationsRecyclerAdapter;

public class LocationDialogFragment extends DialogFragment implements LocationsRecyclerAdapter.ItemClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            recyclerAdapter.setClickListener(LocationDialogFragment.this);
            ...
            for (int i = 0; i < cityListArray.length(); i++) {
                ...
                weather.setLat(lat);
                weather.setLon(lon);
                weather.setIcon(formatting.setWeatherIcon(Integer.parseInt(weatherId), TimeUtils.isDayTime(weather, calendar)));
