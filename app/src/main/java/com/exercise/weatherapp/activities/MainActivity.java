package com.exercise.weatherapp.activities;
...
import com.exercise.weatherapp.AlarmReceiver;
import com.exercise.weatherapp.Constants;
import com.exercise.weatherapp.models.Weather;
import com.exercise.weatherapp.tasks.GenericRequestTask;
import com.exercise.weatherapp.tasks.ParseResult;
import com.exercise.weatherapp.tasks.TaskOutput;
import com.exercise.weatherapp.utils.Formatting;
import com.exercise.weatherapp.utils.TimeUtils;
import com.exercise.weatherapp.utils.UI;
import com.exercise.weatherapp.utils.UnitConvertor;
import com.exercise.weatherapp.widgets.AbstractWidgetProvider;
import com.exercise.weatherapp.widgets.DashClockWeatherExtension;
...
import com.exercise.weatherapp.adapters.ViewPagerAdapter;
import com.exercise.weatherapp.adapters.WeatherRecyclerAdapter;
import com.exercise.weatherapp.fragments.AboutDialogFragment;
import com.exercise.weatherapp.fragments.LocationDialogFragment;
import com.exercise.weatherapp.fragments.RecyclerViewFragment;
...
//        }
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            todayWeather.setIcon(formatting.setWeatherIcon(Integer.parseInt(idString), TimeUtils.isDayTime(todayWeather, Calendar.getInstance())));
    ...
    public ParseResult parseLongTermJson(String result) {
        ...
        try {
            ...
            for (i = 0; i < list.length(); i++) {
                ...
                weather.setIcon(formatting.setWeatherIcon(Integer.parseInt(idString), TimeUtils.isDayTime(weather, cal)));
